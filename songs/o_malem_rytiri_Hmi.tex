...
\cho{}
\ch{Hmi}Jede jede rytíř, \ch{D}jede do kraje,\\
...
\ve{}
\ch{G}Jednou takhle v neděli, \ch{F\guitarSharp{}}slunce pěkně hřálo,\\
\ch{G}bylo kolem poledne, \ch{F\guitarSharp{}}když tu se to stalo.\\
\ch{G}Panáček uhodí \ch{A}pěstičkou do stolu:\\
\uv{\ch{G}Dosti bylo pohodlí \ch{A}a plnejch kastrólů!\\
\ch{Hmi}Ještě dneska stůj co stůj, \ch{A}musím na cestu se dát,\\
\ch{G}tak zavolejte sloužící a \ch{F\guitarSharp{}7}dejte koně osedlat!}
